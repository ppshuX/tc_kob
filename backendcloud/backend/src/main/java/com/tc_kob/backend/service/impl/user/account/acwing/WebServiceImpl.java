package com.tc_kob.backend.service.impl.user.account.acwing;

import com.alibaba.fastjson2.JSONObject;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.tc_kob.backend.mapper.UserMapper;
import com.tc_kob.backend.pojo.User;
import com.tc_kob.backend.service.impl.user.account.acwing.utils.HttpClientUtil;
import com.tc_kob.backend.service.user.account.acwing.WebService;
import com.tc_kob.backend.utils.JwtUtil;
...
public class WebServiceImpl implements WebService {
    private final static String appid = "7600";
    private final static String appSecret = "b623afacde4a48e09674af48ce24b041";
    private final static String redirectUri = "https://app7600.acapp.acwing.com.cn/user/account/acwing/web/receive_code/";
    ...
    public JSONObject applyCode() {
        ...
        try {
            ...
            resp.put("redirect_uri", encodeUrl);
